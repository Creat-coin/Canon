...
unlocked to sign the Canon-Qt.app bundle.
...
allowing somebody to distribute a Canon-Qt.app or bitcoin-qt-setup.exe with a valid
...
prevent the "cnnber hose cryptography" threat (coercing Gavin to sign a bad binary
...
that the Canon-qt.exe file inside the installer had not been tampered with.
