...
// Copyright (c) 2014-2015 The Canon developers
...
uint256 hashGenesisBlock("0x8aa63e7d31e395ae6f1c7f2e17cf167156ff2295a8b6eb2d8b62798fe275102d");
uint256 hashGenesisScrypt("0x8aa63e7d31e395ae6f1c7f2e17cf167156ff2295a8b6eb2d8b62798fe275102d");
...
const string strMessageMagic = "Dottcoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uCNN
                        ...
                        bool* pfMissingInputs)
{
    ...
    if (fCheckInputs)
    {
        ...
        if (fLimitFree && nFees < CTransaction::nMinRelayTxFee)
        {
            ...
            dFreeCount *= pow(1.0 - 1.0/30.0, (double)(nNow - nLastTime));
            nLastTime = nNow;
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 890000 blocks, which will occur approximately every 4 years
    //nSubsidy >>= (nHeight / 890000);
...
unsigned int static GetNextWorkRequiredNew(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
 ...
 unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
 {
	...
	// KGW satrts ate block 18000
    if (pindexLast->nHeight+1 >= 18000) { DiffMode = 2; }
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    int64 nBIP16SwitchTime = 1202138400;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8aa63e7d31e395ae6f1c7f2e17cf167156ff2295a8b6eb2d8b62798fe275102d");
    }
...
void SetGenesisHash() {
        // Genesis Block:
        // CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1396170251, nBits=1d00ffff, nNonce=2083236893, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "27/oct/2017 Les tarifs d'accès à la Tour Eiffel augmentent fortement";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 0x166f4f5d << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1;
	    txNew.vout[0].scriptPubKey = CScript() << ParseHex("8706zwkd0fe7587094s5b77516b7105cd6ae03909a4864e0ea1f78deb734f6bc3f4cef65c4c48e51cb84de5c745df7ba0b8d578a4c702a8ga54f5d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512842488;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xdb7a2a7ebfe7da452f3439bb412a6a9729417993a083d44e6391016a70e8eccf"));
...
unsigned char pchMessageStart[4] = { 0xa1, 0xd1, 0xc2, 0xd2 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CanonMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CanonMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CanonMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Canon-miner");
    ...
    try { loop {
        ...
        printf("Running CanonMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
