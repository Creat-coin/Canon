...
contains(RELEASE, 1) {
    ...
    !win32:!macx {
        # Linux: static link and extra security (see: http://wiki.debian.org/Hardening)
...
# for extra security (see: http://wiki.debian.org/Hardening): this flag is GCC compiler-specific
...
macx:ICON = src/qt/res/icons/canon.icns
